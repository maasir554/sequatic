          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <Link href="/" className="flex items-center gap-3 group">
                ...
                <span className="font-black italic font-playfair text-blue-600 text-lg group-hover:text-blue-700 transition-colors duration-300">
                  Sequatic
                </span>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50/80 rounded-xl px-4 py-2">
                ...
                <span className="font-medium">Welcome, {session?.user?.name || 'User'}</span>
              </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <User className="w-4 h-4" />
                    <span className="hidden sm:inline max-w-32 truncate">{session?.user?.name || 'User'}</span>
